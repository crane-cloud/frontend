...
import SampleTabs from './components/Tabs/SampleFile';
...
const Routes = () => (
  <Router>
    <Switch>
      ...
      <ProtectedRoute isAllowed={hasToken} exact path="/accounts" component={UsersAccounts} />
      ...
      <Route exact path="/tabs" component={SampleTabs} />
    </Switch>
  </Router>
);
