  ...
  render() {
    return (
      <nav className="navbar navbar-dark fixed-top bg-primary flex-md-nowrap p-0 shadow navbar-expand-lg">
        <a className="navbar-brand col-sm-3 col-md-2 mr-0" href="/home">Crane Cloud</a>
        ...
        <div className="collapse navbar-collapse" id="navbarText">
          <div className="navbar-nav mx-auto">
            ...
            <a className="nav-item nav-link text-white" href="/features">Features</a>
            <a className="nav-item nav-link text-white" href="/pricing">Pricing</a>
          </div>
