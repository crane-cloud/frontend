...
export class ResendVerificationEmail extends React.Component {
  constructor() {
    super();
    this.state = {
      email: "",
  ...
  handleSubmit() {
    ...
    if (!email) {
      ...
      axios
        .post(`${API_BASE_URL}/users/verify`, userEmail)
        .then((response) => {
          if (response.data.status === "success") {
            this.setState({
              loading: false,
        ...
        <div className="RightSectionContent">
          {!registered ? (
            <>
              <div className="ResetPasswordContent">
                <div className="ResetPasswordContentHeading">
                  <h1 className="LoginContentTitle">
            ...
            <div className="ResetPasswordSuccessContent">
              <div className="ResetPasswordMessage">
                ...
                <p>
                  We&apos;ve sent a link to your email address to verify your
                  email:&nbsp;
                  <span>{email}</span>
                  <br />
                  <br />
                  The link will expire after 24 hours. Please use this link to
                  verify your email and resume using your account.
                </p>
              </div>
              <div className="ResetPasswordContentBottomLink ResetPasswordLinkContainer">
                <Link to="/login" className="LoginContentLink">
