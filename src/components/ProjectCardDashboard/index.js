...
import getProjectMemory from "../../redux/actions/projectMemory.js";
import { formatMemoryMetrics } from "../../helpers/formatMetrics.js";
...
class ProjectCard extends React.Component {
  ...
  getProjectMemoryMetrics() {
    ...
    const results = formatMemoryMetrics(cardID);
    return results;
  }
  getProjectMemberz() {
    const { cardID } = this.props;
  ...
  render() {
    ...
    return (
      <div className={`DashboardProjectsCard ${admin_disabled ? "unclickable":""}  ${disabled || admin_disabled ? "opequeCard":""}`} title={(disabled === true && !admin_disabled) ? "Disabled project": admin_disabled ? "Admin disabled this project": name }>
