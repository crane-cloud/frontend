...
describe('Test the component', () => {
    ...
    const InputTextComponent = shallow(<InputText  required={true} name="" placeholder="*" value=""  onChange={OnChangeEvent} />);
    ...
    it('checks if InputText rendered as expected on typing', () => { 
        InputTextComponent.find("input").simulate("change", { target: { value: 'typing' } });
