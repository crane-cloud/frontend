  ...
  return (
    <div className={styles.PricingPageMain}>
      ...
      <div className={styles.InforContainer}>
        <div className={styles.PrimaryTitle}>Choose a plan</div>
        <div className={styles.PrimaryTitleLower}>that's right for you</div>
      ...
      <div className={styles.PricingGridContainer}>
        <div className={styles.PricingGrid}>
          <div className={styles.InnerPricingGird}>
            <div className={styles.InnerGridTitle}>CPU</div>
            ...
            <div className={styles.InnerGridPrice}>
              ...
              <div className={styles.PriceDetail}>per 1k seconds</div>
            </div>
          </div>
          <div className={styles.verticalLine}> </div>

          <div className={styles.InnerPricingGird}>
            <div className={styles.InnerGridTitle}>RAM</div>
            <div className={styles.InnerGridText}>
              For teams or companies that need to manage work across
              initiatives.
            </div>
            <div className={styles.InnerGridPrice}>
              <div className={styles.Price}>$4</div>
              <div className={styles.PriceDetail}>per GB</div>
            </div>
          </div>
          <div className={styles.verticalLine}> </div>

          <div className={styles.InnerPricingGird}>
            <div className={styles.InnerGridTitle}>Network</div>
            <div className={styles.InnerGridText}>
              For teams or companies that need to manage work across
              initiatives.
            </div>
          ...
          <div className={styles.InnerPricingGird}>
            <div className={styles.InnerGridTitle}>Storage</div>
            <div className={styles.InnerGridText}>
              For organisations that need additional security, control and
              support.
            </div>
            <div className={styles.InnerGridPrice}>
              <div className={styles.Price}>1$</div>
          ...
          <div className={styles.InnerPricingGird}>
            <div className={styles.InnerGridTitle}>Database</div>
            <div className={styles.InnerGridText}>
              For organisations that need additional security, control and
              support.
            </div>
