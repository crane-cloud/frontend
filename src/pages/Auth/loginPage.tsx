...
export function LoginForm(props: PaperProps) {
  ...
  const { uploadData: gitOAuth, submitting: gitLogin, success: gitLoginSuccess, data: gitUserDetails } = usePost()
  const { uploadData: loginUser, submitting: loggingIn, success: loginSuccess, data: loginDetails } = usePost();
  const { uploadData: registerUser, submitting: registering, success: registerSuccess } = usePost();
  const { uploadData: resetPassword, submitting: sendingResetLink, success: linkSentSuccess } = usePost(); 
         ...
         {!passwordReset ? (
          ...
          <Stack>
            ...
            <Modal
              ...
              onClose={() => {setRegistrationModalOpened(false); form.setFieldValue('email', '');}}
            ...
            >
              <div>
                <Text>
                  ...
                  <br />
                  <br />
                  The link will expire after 24 hours. Please use this link to activate and
