...
import FlutterwaveHook from "../../components/FlutterwaveHook";
import { ReactComponent as Coin } from "../../assets/images/coin.svg";
import { ReactComponent as Flutterwave } from "../../assets/images/flutterwave.svg";
import MetricsCard from "../../components/MetricsCard";
import SpendingPeriod from "../../components/SpendingPeriod";
...
const ProjectBillingPage = (props) => {
  ...
  return (
    ...
    >
        ...
        <div className={styles.BarGraphContainer}>
          ...
          <div className={styles.InnerContainer}>
            ...
            <div className={styles.UsageHistoryHeading}>
              <span
                className={
                  currentUsageTab === "days" ? styles.CurrentTab : styles.Tab
                }
                onClick={() => {
                  viewUsageInDays();
                }}
              ...
              <span
                className={
                  currentUsageTab === "months" ? styles.CurrentTab : styles.Tab
                }
                onClick={() => {
                  viewUsageInMonths();
                }}
      ...
      <div className={styles.TransactionHistoryWrapper}>
        <div className={styles.TransactionHistoryContainer}>
          <div className={styles.TransactionHistoryHeading}>
            <span
              className={
                currentTab === "transactions" ? styles.CurrentTab : styles.Tab
              }
            ...
            <div className={styles.TransactionHistoryBody}>
              <div className={styles.TransactionHistoryTable}>
                <div className={styles.TransactionHistoryHead}>
                  ...
                  <div className={styles.TransactionHistoryCell}>Status</div>
                  <div className={styles.TransactionHistoryCell}>Amount</div>
                  <div className={styles.TransactionHistoryCell}>Details</div>
                </div>
                {transactions?.map((entry, index) => (
                  <div className={styles.TransactionHistoryRow} key={index}>
                    ...
                    <div className={styles.TransactionHistoryCell}>
                      <button
                        onClick={() =>
                          openReceiptModal(transactions, entry.transaction_id)
                        }
            ...
            <div className={styles.ReceiptHistoryBody}>
              <div className={styles.ReceiptHistoryTable}>
                <div className={styles.ReceiptHistoryHead}>
                  ...
                  <div className={styles.ReceiptHistoryCell}>Invoice ID</div>
                  <div className={styles.ReceiptHistoryCell}>Amount Paid</div>
                ...
                {receipts?.map((receipt, receiptIndex) => (
                  <div className={styles.ReceiptHistoryRow} key={receiptIndex}>
                    <div className={styles.ReceiptHistoryCell}>
              ...
              <div className={styles.ModalHistoryBody} ref={ref}>
                ...
                <div className={styles.InvoiceModalHistoryTable}>
                  <div className={styles.InvoiceModalHistoryHead}>
                    ...
                    <div className={styles.InvoiceModalTitle}>Project Name</div>
                    <div className={styles.InvoiceModalTitle}>
                      Total Amount Due
                    </div>
                    <div className={styles.InvoiceModalTitle}>
                  ...
                  <div className={styles.InvoiceModalHistoryRow}>
                    ...
                    <div className={styles.InvoiceHistoryCell}>
                      {inUgx ? (
                        ...
                        <>$ {(invoiceDetails.total_amount / rate).toFixed(3)}</>
                      )}
                    </div>
                    <div className={styles.InvoiceHistoryCell}>
                      {inUgx ? (
      ...
      {viewReceiptFile && (
        <Modal showModal={viewReceiptFile} onClickAway={() => removePreview()}>
          <div className={styles.ModalHistoryBody} ref={ref}>
            <div className={styles.ModalHistoryHeading}>
              <span>
                <img
            ...
            <div className={styles.InvoiceModalHistoryTable}>
              <div className={styles.InvoiceModalHistoryHead}>
                <div className={styles.ReceiptModalTitle}>Date Generated</div>
                <div className={styles.ReceiptModalTitle}>Invoice ID</div>
                <div className={styles.ReceiptModalTitle}>Amount Paid</div>
              ...
              <div className={styles.ReceiptDetailContainer}>
                {transactionDetails && (
                  <>
                    ...
                    <div className={styles.ReceiptLabel}>Payment Status</div>
                    <div className={styles.ReceiptDetail}>
          ...
          <Modal showModal={paymentOptions} onClickAway={closePaymentsOptions}>
            <div className={styles.OptionsModal}>
              ...
              <div className={styles.PaymentForms}>
                ...
                >
                  <div className={styles.PaymentText}>Cash/ResourceCard</div>
