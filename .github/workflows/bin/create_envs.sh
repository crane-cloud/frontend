...
REACT_APP_DATABASE_API_URL="${REACT_APP_DATABASE_API_URL}"
REACT_APP_MONITORING_API_URL="${REACT_APP_MONITORING_API_URL}"
REACT_APP_ACTIVITY_LOGS_API_URL="${REACT_APP_ACTIVITY_LOGS_API_URL}"
...
function create_env_file
{
    ...
    echo REACT_APP_DATABASE_API_URL=$REACT_APP_DATABASE_API_URL >> .env
    echo REACT_APP_MONITORING_API_URL=$REACT_APP_MONITORING_API_URL >> .env
    echo REACT_APP_ACTIVITY_LOGS_API_URL=$REACT_APP_ACTIVITY_LOGS_API_URL >> .env
}
